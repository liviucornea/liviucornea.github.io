...
export class SchematicApiService {
    ...
    pipeLineBaseUrl:string = this.prefixurl + '/pipeline';
    pipeLineSchematicBaseUrl:string = this.prefixurl + '/pipelineschematic';
...
// pipeline region
    ...
    deleteMultiplePipelineSchematics(obj) {
        return this.httpAbs.removeBulkRecords(this.pipeLineSchematicBaseUrl + '/multiple'
            , JSON.stringify(obj),''
            , '',  this.contentType);
    }

    getPipelineByDescription(descrtiption: string) {
        return this.httpAbs.fetch(this.pipeLineBaseUrl +'?LookupKey=' + descrtiption);
    }

    insertMultiplePipelineSchematics(obj) {
        return this.httpAbs.insertWithHeader(this.pipeLineSchematicBaseUrl + '/multiple'
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }

    updateMultiplePipelineSchematics(obj) {
        return this.httpAbs.updateWithHeader(this.pipeLineSchematicBaseUrl + '/multiple'
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }

    updatePipeline(obj, primaryKeyColumn) {
        var Id = 0;
        Id = this.getIdValue(obj, primaryKeyColumn);
        return this.httpAbs.updateWithHeader(this.pipeLineBaseUrl + '/' + Id
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }
    ...
    createPipeline(obj) {
        return this.httpAbs.insertWithHeader(this.pipeLineBaseUrl
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }
    ...
    getSchematicsForPipelineById(id:string) {
    ...
    cloneStepToSchematic(obj: any ): Observable<any> {
        return this.httpAbs.insertWithHeader(this.schematicBaseUrl + '/clonestep/'
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }

    deleteStepByStepId(id: number): Observable<any> {
        return this.httpAbs.remove(this.schematicBaseUrl + '/step/' + id );
    }

    //Clone Schematic by id
    cloneSchematicbyId(obj: any): Observable<any> {
        return this.httpAbs.insertWithHeader(this.schematicBaseUrl + '/clone/'
            , JSON.stringify(obj)
            , '', ''    //empty headers
            , this.contentType);
    }
    genSQLScriptBySchematicId(id: number): Observable<any> {
