export var CustomizeFieldsListConfig = {
    CustomButtons: [
        {
            name: 'Save',
            value: 'Save',
...
export var ReportStatusChildGridConfig = {
...
export var ViewIssuesChildGridConfig = {
...
let TradesSummaryDisplayGridConfig= {
    ChildType: "",
    ...
    ColumnConfiguration:[{
        ...
        "dataSource": undefined,
        "isToggleable": true,
        "ChildControlConfig": ReportStatusChildGridConfig
    },{
        "dbColumnName": "Issues",
        "htmlControlType": "text",
        "isVisible": true,
        ...
        "dataSource": undefined,
        "isToggleable": true,
        "ChildControlConfig": ViewIssuesChildGridConfig
    },{
        "dbColumnName": "System",
        "htmlControlType": "text",
        "isVisible": true,
...
let TradesDetailsDisplayGridConfig= {
    ChildType: "",
    ChildGridType: "displayGrid",
    PrimaryKeyColumn: "CoreID",
    ForeignKeyColumn: "",
...
export var  TradesControlConfig = {
    TabsList: [
        {
            TabKey: "OneTab",
            TabName: "OneTab",
