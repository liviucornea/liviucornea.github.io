import {ValidateTargetForExclude, ValidateTargetForInclude} from './msiValidationFunctions' ;
...
export var DisplayGridMasterConfig= {
    ChildType: "",
    ShallHideAddButton: true,
    ShallHideDeleteButton: true,
    ...
    RulesConfig: [
        {
            ...
            "ruleValue": {"targets": ["RegionExclude", "CountryExclude"], "ruleFunction": ValidateTargetForExclude },
            ...
            "applyTo": "OneOf",
            "ruleName": ["requiredTarget"],
            "ruleValue": {"targets": ["RegionInclude", "CountryInclude"], "ruleFunction": ValidateTargetForInclude },
    ...
    TabsList: [
        {
            ...
            TabControls:[
                ...
                },
                {
                    ...
                    gridSettings: DisplayGridMasterConfig,
