import {CompareOperator} from "../../../../../../ReusableServices/rulesSource/StandardValidation/Validation";
    ...
    RulesConfig: [
        {
            ...
            "apiObject": "",
            "ruleValue": {CompareTo: "EndDate", CompareOperator: CompareOperator.LessThanEqual}
        }]
};


export var  RiskAnalyticsBenchmarksControlConfig = {
    TabsList: [
        {
            TabKey: "OneTab",
            TabName: "OneTab",
