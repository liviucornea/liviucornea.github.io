System.register(['@angular/core', '@angular/router', "../../../ReusableComponents/navbarVert/navbarVert", "../../../ReusableServices/navigationService"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            Logs = (function () {
                function Logs(navService) {
                    this.navService = navService;
                    //this.navService..setLeftNavigationItems(this.navContent);
                    this.navService.getLeftMenuRoutes('Logs');
                }
                Logs = __decorate([
                    core_1.Component({
                        selector: 'logs',
                        templateUrl: '../../..//Datahub/routes/logs/logs.html',
