    ...
    return {
        ...
        execute: function() {
            SchematicApiService = (function () {
                ...
                SchematicApiService.prototype.ExecutePageRefersh = function (pagename, id) {
            ...
            exports_1("SchematicApiService", SchematicApiService);
        }
    }
});
