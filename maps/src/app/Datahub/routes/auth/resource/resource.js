System.register(["@angular/core", "@angular/router", "../../../../ReusableComponents/displayGrid/displayGrid", "../../../pipes/tokenFilter", "../../../../ReusableServices/alertService", "../../../../ReusableServices/apiService", "../../../../ReusableServices/componentsConfigService", "../../../../ReusableComponents/navbarVert/navbarVert"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, displayGrid_1, tokenFilter_1, alertService_1, apiService_1, componentsConfigService_1, navbarVert_1;
    var AuthResource;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AuthResource = (function () {
                function AuthResource(ap, alt, componentsConfigService) {
                    this.ap = ap;
                    this.alt = alt;
                    this.componentsConfigService = componentsConfigService;
                    this.newResource = {};
                    this.searchKey = "";
                    this.childConfig = this.componentsConfigService.AuthResourceControlConfig.theChild;
                    this.controlConfig = this.componentsConfigService.AuthResourceControlConfig.theParent;
                    this.api = ap;
                    this.alert = alt;
                }
                ...
                AuthResource.prototype.refreshResources = function () {
                    this.dataTable.GetParentPageDetails(this.controlConfig, this.api, "resource");
                };
                __decorate([
            ...
            exports_1("AuthResource", AuthResource);
        }
    }
});
