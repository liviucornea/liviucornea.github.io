System.register(["@angular/core", "@angular/router", "../../../pipes/tokenFilter", "../../../../ReusableComponents/displayGrid/displayGrid", "../../../../ReusableServices/apiService", "../../../../ReusableServices/alertService", "../../../../ReusableServices/componentsConfigService", "../../../../ReusableComponents/navbarVert/navbarVert"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AuthUser = (function () {
                function AuthUser(ap, alt, componentsConfigService) {
                    this.ap = ap;
                    this.alt = alt;
                    this.componentsConfigService = componentsConfigService;
                    this.newUser = {};
                    this.searchKey = "";
                    this.controlConfig = this.componentsConfigService.AuthUserControlConfig;
                    this.api = ap;
                    this.alert = alt;
                }
                AuthUser.prototype.ngAfterViewInit = function () {
                    this.refreshUsers();
                };
                ...
                ], AuthUser.prototype, "dataTable", void 0);
                AuthUser = __decorate([
                    core_1.Component({
                        selector: 'auth',
