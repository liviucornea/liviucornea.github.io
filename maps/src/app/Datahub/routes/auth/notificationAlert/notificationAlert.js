System.register(["@angular/core", "@angular/router", "../../../../ReusableComponents/displayGrid/displayGrid", "../../../pipes/tokenFilter", "../../../../ReusableServices/apiService", "../../../../ReusableServices/componentsConfigService", "../../../../ReusableServices/alertService", "../../../../ReusableComponents/navbarVert/navbarVert"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, displayGrid_1, tokenFilter_1, apiService_1, componentsConfigService_1, alertService_1, navbarVert_1;
    ...
    return {
        ...
        execute: function() {
            NotificationAlert = (function () {
                function NotificationAlert(ap, alt, componentsConfigService) {
                    this.ap = ap;
                    this.alt = alt;
                    this.componentsConfigService = componentsConfigService;
                    this.newRole = {};
                    this.searchKey = "";
                    this.controlConfig = this.componentsConfigService.NotificationAlertControlConfig;
                    this.api = ap;
                    this.alert = alt;
                }
            ...
            exports_1("NotificationAlert", NotificationAlert);
        }
    }
});
