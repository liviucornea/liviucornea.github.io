System.register(['@angular/core', '@angular/router', "../../../ReusableComponents/navbarVert/navbarVert", "../../../ReusableServices/navigationService"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            Auth = (function () {
                function Auth(navService) {
                    this.navService = navService;
                    this.navService.getLeftMenuRoutes('Auth');
                }
                Auth = __decorate([
                    core_1.Component({
                        selector: 'auth',
                        templateUrl: '../../..//Datahub/routes/auth/auth.html',
                        directives: [router_1.RouterLink, router_1.RouterOutlet, navbarVert_1.NavBarVert],
                    }), 
