...
import {ToastData, ToastyConfig, ToastyService} from "../../../ReusableServices/toasty.service";
...
export class CalendarToastyComponent {
  /**
  ...
  @Input() set position(value: string) {
    if (value) {
      let notFound = true;
      for (let i = 0; i < CalendarToastyComponent.POSITIONS.length; i++) {
  ...
  constructor(private config: ToastyConfig, private toastyService: CalendarToastyService) {
    // Initialise position
    this.position = '';
  }
