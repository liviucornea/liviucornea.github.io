 ...
 */
@Injectable()
export class CalendarToastyConfig {
 ...
 */
@Injectable()
export class CalendarToastyService {
    // Allowed THEMES
    ...
    public eventsArrival:EventEmitter<any>= new EventEmitter<any>();

    public eventTypeChanged:EventEmitter<any>=new EventEmitter<any>();

    constructor(private config: CalendarToastyConfig) {}
