System.register(["../app.router.metadata"], function(exports_1, context_1) {
    ...
    var Auth_RouteInfo, AUTH_ROUTES, TradeReports_RouteInfo, TRADE_REPORTS_ROUTES, Tools_RouteInfo, TOOLS_ROUTES, ExceptionReports_RouteInfo, EXCEPTION_REPORTS_ROUTES, Applications_RouteInfo, APPLICATIONS_ROUTES, Schedule_RouteInfo, SCHEDULE_ROUTES, Logs_RouteInfo, LOGS_ROUTES, Schematic_RouteInfo, SCHEMATIC_ROUTES, Admin_RouteInfo, ADMIN_ROUTES, Datahub_RouteInfo, DATAHUB_ROUTES, HtmlRoutes;
    return {
        setters:[
        ...
        execute: function() {
            ...
            Admin_RouteInfo = [
                ...
                // { path: 'treeViewBuilder', name: 'treeViewBuilder', title: 'TreeView Builder', menuType: MenuType.TOP },
                { path: 'ApplicationTreeView', name: 'ApplicationTreeView', title: 'Application TreeView', menuType: app_router_metadata_1.MenuType.TOP },
...
//# sourceMappingURL=htmlRooutes.js.map