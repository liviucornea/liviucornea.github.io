...
export class AuthResource {
    ...
    newResource:any = {};
    searchKey:string = "";
    childConfig:any = this.componentsConfigService.AuthResourceControlConfig.theChild;
    controlConfig:any = this.componentsConfigService.AuthResourceControlConfig.theParent;
